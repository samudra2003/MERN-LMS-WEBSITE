    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          ...
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
            <img src={assets.appointments_icon} alt=" patients_icons" />
            <div >
          ...
          <div className='flex items-center gap-3 shadow-card border border-blue-500 p-4 w-56 rounded-md'>
            <img src={assets.earning_icon} alt=" earning_icons" />
            <div >
        ...
        <div>
          <h2 className='text-lg font-medium pb-4'>Recent Enrollments</h2>
                ...
                {dashboardData.enrolledStudentsData.map((student, index) => (
                  <tr key={index} className='border-b border-gray-500/20'>
                    ...
                    <td className='md:px-4 px-2 py-3 flex items-center space-x-3'>
                      <img src={student.student.imageUrl} alt="avatar" className='w-9 h-9 rounded-full' />
                      <span className='truncate'>{student.student.name}</span>
                    </td>
                    <td className='px-4 py-6 truncate'>{student.courseTitle}</td>
                  </tr>
                ))}
              </tbody>
            </table>
