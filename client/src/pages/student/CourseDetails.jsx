    ...
    items-start justify-between px-8 md:px-36 md:pt-30 pt-20 text-left"
      >
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">Samudra</span>
          </p>
          <div className="pt-8 text-gray-800">
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                <div
                  key={index}
                  className="border border-gray-300  rounded-lg mb-2 bg-white"
                >
                  <div
        ...
        <div className="max-w-[424px] z-10 shadow-lg rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <p className="text-green-500">{courseData.discount}% off</p>
            </div>
            ...
            <button className="bg-blue-600 text-white  py-3 rounded md:mt-6 mt-4  w-full font-medium">
            ...
            <div className="pt-6">
              ...
              <ul className="list-disc ml-4 pt-2 text-sm md:text-default text-gray-500">
